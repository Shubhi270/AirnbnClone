   ...
   if (showAllPhotos) {
     return (
       <div className="absolute bg-black text-white min-w-full min-h-screen">
         <div className="p-8 gap-4 flex flex-col items-center bg-black">
           <div>
             <h2 className="text-3xl mr-48">{place.title}</h2>
             <button
               onClick={() => setShowAllPhotos(false)}
               className="fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl bg-white text-black"
             >
               Close photos
             </button>
           </div>
