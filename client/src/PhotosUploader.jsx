  ...
  return (
    <div>
      ...
      <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-2 text-white bg-black bg-opacity-50 rounded-xl p-1"
              >
                <svg
        ...
        <label className="h-32 cursor-pointer flex justify-center items-center border bg-transparent rounded-2xl p-2 text-2xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
